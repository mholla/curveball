...
# Viridis Color Map
plt.figure()
sns.kdeplot(cup_t, color='#FDE725', shade=False, label='Cup',bw_adjust=1,cut=0)
sns.kdeplot(trough_t, color='#B4DE2C', shade=False, label='Trough',bw_adjust=3,cut=0)
sns.kdeplot(rut_t, color='#6DCD59', shade=False, label='Rut',bw_adjust=3,cut=0)
sns.kdeplot(srut_t, color='#35B779', shade=False, label='Saddle_Rut',bw_adjust=3,cut=0)
sns.kdeplot(saddle_t, color='#1F9E89', shade=False, label='Saddle',bw_adjust=3,cut=0)
sns.kdeplot(sridge_t, color='#26828E', shade=False, label='Saddle_ridge',bw_adjust=3,cut=0)

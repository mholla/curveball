"""
Regional surface data generated from the Destrieux atlas. The label files are generated using Freesurfer.
From label files, the vertices the belong to each spcific region are extracted. And from that information
the surface files for each region are saved.


Parameters:
---------
    {h}.{l}.label: Label files of each region for each hemisphere generated using the Destrieux atlas.
    curv: surface files for each hemisphere, SI, H, K, thickness, sulc, sulc.shrink

Returns:
------
    {h}.pial.{c}.{l}.asc: surface files generated for each region of the Destrieux atlas (SI, H, K)
    {h}.{c}.{l}.asc: surface files generated for each region of the Destrieux atlas (thickness, sulc, sulc.shrink)
"""

def region_Destrieux(subjects_dir,subject,x,y,z,hemi):

...
read subjects line-by-line from the user-defined subjects_xxxxxx.txt file
create a subjects_dir folder, create a subfolder that has individual subjects folder with a unique folder name
(same as the subjects name), create a subfolder named surf below each individual subjects folder

Returns:
-------

All the returns of each script. Read the instructions for each script. 
"""

"""
Regional surface data generated from the Brodmann atlas. The label files are generated using Freesurfer.
...
Parameters:
---------
    {h}.{l}.label: Label files of each region for each hemisphere generated using the Brodmann atlas.
    curv: surface files for each hemisphere, SI, H, K, thickness, sulc, sulc.shrink

Returns:
------
    {h}.pial.{c}.{l}.asc: surface files generated for each region of the Brodmann atlas (SI, H, K)
    {h}.{c}.{l}.asc: surface files generated for each region of the Brodmann atlas (thickness, sulc, sulc.shrink)
    
"""

def region_Brodmann(subjects_dir,subject,x,y,z,hemi):

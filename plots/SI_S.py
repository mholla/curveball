"""
Variation of average cortical thickness with respect to shape index and sulcal depth 
...
Returns:
-------
    t_map: average cortical thickness map for each subject bounded by shape index and sulcal depth
...
"""
def SI_S(input_txt, subjects_name, output_folder):
    ...
    file = os.path.join('/afs/crc.nd.edu/group/commandlab/Nagehan/curveball_scripts/plots', output_folder, 'si_s_t.npy')
    np.save(file, t_ave_map)
    
    file = os.path.join('/afs/crc.nd.edu/group/commandlab/Nagehan/curveball_scripts/plots', output_folder, 'si_s_ind.npy')
